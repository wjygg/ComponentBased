...
public class CompressBitmap {
    ...
    private CompressBitmap(Context context){

        this.context=context;
    }

   public static CompressBitmap getInstance(Context context){
       ...
       if(compressBitmap==null){
           ...
           synchronized (CompressBitmap.class){
               ...
               if(compressBitmap==null){
                   ...
                   compressBitmap=new CompressBitmap(context.getApplicationContext());
               }
           }
       }
    ...
    private String getOutputFileName(String srcFilePath) {
        ...
        File file = new File(Environment.getExternalStorageDirectory().getPath(), "ComponentBased/Images");
        if (!file.exists()) {
            file.mkdirs();
        }
